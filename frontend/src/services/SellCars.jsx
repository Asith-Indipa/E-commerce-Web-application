      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className={`border rounded px-3 py-3 w-full min-w-0 block text-base pr-12 ${showValidation && (!mileage || isNaN(mileage) || Number(mileage) < 0) ? "border-red-500" : ""}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className={`border rounded px-3 py-3 w-full min-w-0 block text-base pr-12 ${showValidation && (!engine || isNaN(engine) || Number(engine) < 1) ? "border-red-500" : ""}`}
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            value={fuel ? { value: fuel, label: fuel } : null}
            onChange={option => setFuel(option ? option.value : "")}
            isClearable
            placeholder="Fuel type"
            classNamePrefix="react-select"
            className={showValidation && !fuel ? "border-red-500" : ""}
          />
          {!fuel && showValidation && (
            <div className="text-xs text-red-500 mt-1">You must fill out this field.</div>
          )}
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            value={transmission ? { value: transmission, label: transmission } : null}
            onChange={option => setTransmission(option ? option.value : "")}
            isClearable
            placeholder="Transmission"
            classNamePrefix="react-select"
            className={showValidation && !transmission ? "border-red-500" : ""}
          />
        ...
        <div className="space-y-2">
          ...
          <Select
            options={bodyTypes.map(b => ({ value: b.label, label: `${b.emoji} ${b.label}` }))}
            value={bodyType ? { value: bodyType, label: `${bodyTypes.find(b => b.label === bodyType)?.emoji || ""} ${bodyType}` } : null}
            onChange={option => setBodyType(option ? option.value : "")}
            isClearable
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className={`border rounded px-3 py-3 w-full min-w-0 block text-base pr-12 ${showValidation && (!price || isNaN(price) || Number(price) <= 0) ? "border-red-500" : ""}`}
